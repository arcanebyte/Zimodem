/*
   Copyright 2016-2019 Bo Zimmerman, 2020-2021 James Denton (ArcaneByte)
...
#define ZIMODEM_VERSION "3.6.1"
#define ARCANEBYTE_VERSION "1.5-3.6.1"
...
# define DEFAULT_FCT FCT_DISABLED
//# define RS232_INVERTED 1 // Define for inverted RS232
